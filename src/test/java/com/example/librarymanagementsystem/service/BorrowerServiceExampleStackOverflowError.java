...
class BorrowerServiceExampleStackOverflowError {
    ...
    void testRegisterBorrower() {
        // Given
        BorrowerDTO borrowerDTO = new BorrowerDTO(null, "test@example.com", "com.example.librarymanagementsystem.controller.Test Borrower");
        Borrower savedBorrower = new Borrower(1L, "test@example.com", "com.example.librarymanagementsystem.controller.Test Borrower");
        ...
        assertEquals("com.example.librarymanagementsystem.controller.Test Borrower", result.getName());
    }

    @Test
    void testBorrowBook() {
        // Given
        Borrower borrower = new Borrower(1L, "test@example.com", "com.example.librarymanagementsystem.controller.Test Borrower");
        Book book = new Book(1L, "1234567890", "com.example.librarymanagementsystem.controller.Test Book", "com.example.librarymanagementsystem.controller.Test Author", null);
    ...
    void testBorrowBook_BookNotFound() {
        ...
        Long borrowerId = 1L;
        Long bookId = 1L;
        Borrower borrower = new Borrower(borrowerId, "borrower@example.com", "com.example.librarymanagementsystem.controller.Test Borrower");
