...
class BorrowerControllerExampleStackOverflowError {
    ...
    @BeforeEach
    void setUp() {
        mockBorrowerDTO = new BorrowerDTO(1L, "test@example.com", "com.example.librarymanagementsystem.controller.Test Borrower");
    }
