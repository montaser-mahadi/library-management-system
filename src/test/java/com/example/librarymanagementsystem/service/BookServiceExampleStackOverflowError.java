...
class BookServiceExampleStackOverflowError {
    ...
    void testRegisterBook() {
        // Given
        BookDTO bookDTO = createBookDTO("1234567890", "com.example.librarymanagementsystem.controller.Test Book", "com.example.librarymanagementsystem.controller.Test Author");
    ...
    void testRegisterBookWithExistingISBNAndSameTitleAuthor() {
        // Given
        BookDTO bookDTO = createBookDTO("1234567890", "com.example.librarymanagementsystem.controller.Test Book", "com.example.librarymanagementsystem.controller.Test Author");
        Book existingBook = new Book(1L, "1234567890", "com.example.librarymanagementsystem.controller.Test Book", "com.example.librarymanagementsystem.controller.Test Author", null);
    ...
    void testRegisterBookWithExistingISBNAndDifferentTitle() {
        // Given
        BookDTO bookDTO = createBookDTO("1234567890", "Different Title", "com.example.librarymanagementsystem.controller.Test Author");
        Book existingBook = new Book(1L, "1234567890", "com.example.librarymanagementsystem.controller.Test Book", "com.example.librarymanagementsystem.controller.Test Author", null);
        List<Book> existingBooks = List.of(existingBook);
    ...
    void testRegisterBookWithExistingISBNAndDifferentAuthor() {
        // Given
        BookDTO bookDTO = createBookDTO("1234567890", "com.example.librarymanagementsystem.controller.Test Book", "Different Author");
        Book existingBook = new Book(1L, "1234567890", "com.example.librarymanagementsystem.controller.Test Book", "com.example.librarymanagementsystem.controller.Test Author", null);
        List<Book> existingBooks = List.of(existingBook);
