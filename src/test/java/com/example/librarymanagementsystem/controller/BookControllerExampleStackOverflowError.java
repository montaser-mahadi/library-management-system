...
class BookControllerExampleStackOverflowError {
    ...
    @BeforeEach
    void setUp() {
        mockBookDTO = new BookDTO(1L, "1234567890", "com.example.librarymanagementsystem.controller.Test Book", "com.example.librarymanagementsystem.controller.Test Author", null);
    }
